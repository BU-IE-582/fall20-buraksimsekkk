...
```{r Ploting P(homewin) - P(away win), warning=FALSE ,message=FALSE}
...
```{r Ploting Some Bookmaker1 P(homewin) - P(away win), warning=FALSE ,message=FALSE}
...
```{r Ploting Pinnacle P(homewin) - P(away win), warning=FALSE ,message=FALSE}
...
```{r Ploting Some Bookmaker2 P(homewin) - P(away win), warning=FALSE ,message=FALSE}
...
```{r Ploting no red  , warning=FALSE ,message=FALSE}

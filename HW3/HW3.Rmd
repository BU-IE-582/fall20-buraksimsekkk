...
Average performance of penalized regression approaches gives %2.44 error rate which is the best model so far. From all of these result, we can deduce that electricity usage depends on seasonilities of hours and days.
